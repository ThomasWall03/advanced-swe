...
class SharedFilterService private constructor(
    ...
    companion object {
        ...
        fun getInstance(sharedFilterRepository: SharedFilterRepositoryInterface): SharedFilterService =
    ...
    suspend fun saveFiltersForProfile(
        profileId: Int,
        selectedDrinkTypeOptions: List<String>,
        selectedIngredientOptions: List<String>,
    ) {
